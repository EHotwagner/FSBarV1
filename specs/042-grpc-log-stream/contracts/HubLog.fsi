...
module HubLog =
    ...
    /// Interface implemented by `T` for `System.IDisposable`.
    /// Dispose cancels every subscriber `CancellationTokenSource`,
    /// completes the per-subscriber channel writers, and guarantees
    /// resource release within 1 s (FR-013).
