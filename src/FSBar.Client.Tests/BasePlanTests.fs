...
let private flatGrid = SyntheticMapGrid.flat 128 128

let private baseCentre : float32 * float32 * float32 = (512.0f, 0.0f, 512.0f)
let private commanderPos : float32 * float32 * float32 = (512.0f, 0.0f, 512.0f)
...
let private twoMetalSpots : (float32 * float32 * float32 * float32) array =
